...
namespace LINQDemo.Testing
{
    public class NonGenericCollectionTest
    {
        ...
        public static IEnumerable<object[]> GetTestData()
        {
            ...
            //yield: when we want to return a collection from a method in some form of fashion. Building it piece by piece
        }
        ...
        {
            var col = new NonGenericCollection();
            Assert.Throws<ArgumentNullException>("item", () => col.Contains(null));
        }
    }
}
